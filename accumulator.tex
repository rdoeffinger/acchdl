...
\begin{tabular}{|r|l|l|}
\hline
\tabline {Bit} {Name}     {Remarks}
\hline
\tabline {0}   {sign}     {writing only useful for restoring}
\tabline {1}   {overflow} {helps finding $\infty$ and NaN in input data}
\tabline {2}   {zero}     {set to 1 and sign to 0 to clear register}
\hline
\end{tabular}
\caption{ALU flags}
\end{center}
